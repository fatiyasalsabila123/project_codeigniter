...
<div class="card p-3">
        ...
        <form method="post" class="row" action="<?php echo base_url('admin/aksi_ubah_siswa')?>" enctype="multipart/form-data">
            ...
            <div class="mb-3 col-6">
                ...
                <input type="text" value="<?php echo $row->username?>" name="username" class="form-control" id="nama">
            </div>
            <div class="mb-3 col-6">
            ...
            <div class="mb-3 col-6">
                ...
                <!-- Input field untuk nisn -->
                <input type="text" value="<?php echo $row->tempat_lahir?>" name="nisn" class="form-control" id="nisn">
            </div>
            <div class="mb-3 col-6">
                <label for="nisn" class="form-label">Tanggal Lahir</label>
                <!-- Input field untuk nisn -->
                <input type="text" value="<?php echo $row->tanggal_lahir?>" name="nisn" class="form-control" id="nisn">
            </div>
            <div class="mb-3 col-6">
                <label for="nisn" class="form-label">Kelas</label>
                <!-- Input field untuk nisn -->
                <input type="text" value="<?php echo $row->kelas?>" name="nisn" class="form-control" id="nisn">
            </div>
            <div class="mb-3 col-6">
                <label for="nisn" class="form-label">Jurusan</label>
                <!-- Input field untuk nisn -->
                <input type="text" value="<?php echo $row->jurusan?>" name="nisn" class="form-control" id="nisn">
            </div>
            <div class="mb-3 col-6">
